 ...
 * @author GeWuYou
 * @version V1.0.0
 * @ClassName PrintBinaryTreeInZigzagSequence
 * @apiNote </br>
 * @since 2022/12/30 19:34
 */
public class PrintBinaryTreeInZigzagSequence {
     ...
     */
    public void Print(List<ArrayList<Integer>> result, Queue<TreeNode> queue, int layers) {
