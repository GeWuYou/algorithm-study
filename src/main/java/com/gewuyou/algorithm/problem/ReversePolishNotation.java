...
public class ReversePolishNotation {
     ...
     * 括号优先级
     */
    private static final Integer LEVEL_HIGH = Integer.MAX_VALUE;
    ...
    public static int calcLevel(String s) {
        if (PLUS_SIGN.equals(s) || MINUS_SIGN.equals(s)) {
            return LEVEL_1;
        } else if (MULTIPLICATION_SIGN.equals(s) || DIVISION_SIGN.equals(s)) {
            return LEVEL_2;
        }
        return LEVEL_HIGH;
    }
