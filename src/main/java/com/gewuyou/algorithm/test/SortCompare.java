...
import com.gewuyou.algorithm.sort.Insertion;
import com.gewuyou.algorithm.sort.Merge;
import com.gewuyou.algorithm.sort.Shell;
...
public class SortCompare {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("resource/reverse_arr.txt")));
        String line = null;
        ...
        list.toArray(a);
        //4.调用测试代码完成测试
        // testInsertion(a);//37499毫秒 19590毫秒
        // testShell(a);//30毫秒 15毫秒
       testMerge(a);//15毫秒
