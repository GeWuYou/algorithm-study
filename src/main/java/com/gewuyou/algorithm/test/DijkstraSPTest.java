...
import com.gewuyou.algorithm.graph.DijkstraSP;
import com.gewuyou.algorithm.graph.DirectedEdge;
import com.gewuyou.algorithm.graph.EdgeWeightedDigraph;
...
public class DijkstraSPTest {
    ...
    public static void main(String[] args) throws Exception{
        //创建一副加权有向图
        BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("resource/min_route_test.txt")));
